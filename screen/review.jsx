  ...
  function renderre(){
        return(
          ...
          <View style={{ alignItems:'center',flexDirection: 'row',}}>
            <Image source={_point >= 1 ? require('../assets/images/icons/StarOutline.png') : require('../assets/images/icons/Star.png')} style={{height:20, width:20,marginLeft:5}}></Image>
            <Image source={_point >= 2 ? require('../assets/images/icons/StarOutline.png') : require('../assets/images/icons/Star.png')} style={{height:20, width:20,marginLeft:5}}></Image>
            <Image source={_point >= 3 ? require('../assets/images/icons/StarOutline.png') : require('../assets/images/icons/Star.png')} style={{height:20, width:20,marginLeft:5}}></Image>
            <Image source={_point >= 4 ? require('../assets/images/icons/StarOutline.png') : require('../assets/images/icons/Star.png')} style={{height:20, width:20,marginLeft:5}}></Image>
            <Image source={_point >= 5 ? require('../assets/images/icons/StarOutline.png') : require('../assets/images/icons/Star.png')} style={{height:20, width:20,marginLeft:5}}></Image>
            <Text style={{marginLeft:20, fontSize: 20, color:'#000000', fontWeight:'400'}}>คะแนน {_point}</Text>
          </View>
        </View>
        <View style={{flexDirection:'row', marginTop: 7, marginHorizontal:25,marginLeft:85}}>
        ...
        <View style={{ marginLeft: 50,marginTop:10,alignItems:'center',flexDirection: 'row',}}>
          {
